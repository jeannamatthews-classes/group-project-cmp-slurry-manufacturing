...
<body>
          ...
          <div>
            ...
            <table style="border: 1px solid black">
              <tr>
                ...
                <td><input id="IdleElectricityConsumptionInput" type="text" value="0"></td>
              </tr>
              <tr>
                <td>Active Electricity Consumption(kWh)</td>
                <td><input id="ActiveElectConsumptionInput"type="text" value="0"></td>
              </tr>
              <tr>
                <td>Heating/Cooling Energy(kWh)</td>
                <td><input id="HeatingCoolingEnergyInput" type="text" value="0"></td>
              </tr>
              <tr>
                <td>Total Energy Consumption(kWh)</td>
                <td><input id="TotalEnergyConsumptionInput" type="text" value="0"></td>
              </tr>
            </table>
            ...
            <tr>
                ...
                <td><input class="Required" type="text" ></td>
                <td><input id="CO2DataInput" type="text" ></td>
              </tr>
            </table>
    ...
    <script  src="AutoCalcListeners.js" type="text/javascript"></script>
</body>
